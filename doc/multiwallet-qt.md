...
In order to support loading of multiple wallets in xdna-qt, a few changes in the UI architecture will be needed.
...
Changes to xdna.cpp
----------------------
xdna.cpp is the entry point into xdna-qt, and as such, will require some minor modifications to provide hooks for
