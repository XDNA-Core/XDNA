...
*Setup instructions for a gitian build of XDNA using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the XDNA
...
To build XDNA (for Linux, OSX and Windows) just follow the steps under 'perform
