...
This means one can have an always-on xdnad instance running, and another local xdnad/xdna-qt instance which connects to this node and receives blocks from it.
