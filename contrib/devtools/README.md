...
Setup
---------
Configuring the github-merge tool for the XDNA repository is done in the following way:

    git config githubmerge.repository XDNA-Project/XDNA
...
A script to optimize png files in the XDNA
